...
//       <aside
//         className={`${isOpen ? 'translate-x-0' : '-translate-x-full'
//           } lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-40 w-20 border-r border-border transition-transform duration-300 flex flex-col items-center justify-center lg:justify-start lg:py-6 gap-4 shrink-0`}
//       >
//         {menuItems.map((item) => {
//           const Icon = item.icon;
//           const isActive = pathname === item.href;
...
//       {isOpen && (
//         <div
//           className="lg:hidden fixed inset-0 bg-background bg-opacity-50 z-30"
//           onClick={onClose}
//         />
//       )}
//     </>
